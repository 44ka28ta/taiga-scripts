if [ ! -e ~/.setup/buildessential ]; then
    ...
    apt_install autoconf flex bison libjpeg8-devel libjpeg62-devel libfreetype6 freetype2-devel zlib-devel libzmq5 zeromq-devel gdbm-devel ncurses-devel automake libtool libffi48-devel curl gettext-tools cairo-tools
